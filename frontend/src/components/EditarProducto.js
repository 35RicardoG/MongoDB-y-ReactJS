...
class EditarProducto extends React.Component {
    ...
    async componentDidMount() {
        ...
        const respuesta = await fetch(`${Constancia.RUTA_API}/${id}`);
            ...
            <div className = "column is-one-third">
                ...
                <form className = "field" onSubmit = {this.manejarEnvioFormulario}>
                    <div className = "form-group">
                        ...
                        <input autoFocus required placeholder = "Otro... marca" type = "text" id = "marca" onChange = {this.manejarCambio} value = {this.state.products.marca} className = "input"></input>
                    </div>
                    <div className = "form-group">
                        <label className = "label" htmlFor = "producto"> Producto </label>
                        <input required placeholder = "Otro... producto" type = "text" id = "producto" onChange = {this.manejarCambio} value = {this.state.products.producto} className = "input"></input>
                    </div>
                    <div className = "form-group">
                        <label className = "label" htmlFor = "precio"> Precio </label>
                        <input autoFocus required placeholder = "Otro... precio" type = "number" id = "precio" onChange = {this.manejarCambio} value = {this.state.products.precio} className = "input"></input>
                    </div>
                    <div className = "form-group">
                        <label className = "label" htmlFor = "descripcion"> Descripcion </label>
                        <input required placeholder = "Otro... descripcion" type = "text" id = "descripcion" onChange = {this.manejarCambio} value = {this.state.products.descripcion} className = "input"></input>
                    </div>
                    <div className = "form-group">
